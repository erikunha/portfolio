...
- Before approving any plan: check against AGENTS.md "Out of scope" list and DECISIONS.md
...
**Gate 1 — Scope**
Does any item in the spec appear in the AGENTS.md "Out of scope" list or DECISIONS.md as a rejected pattern?
