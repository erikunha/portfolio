...
export function MobileTitleBar() {
  return (
    <div className="sticky top-7 z-[109] flex items-center gap-2.5 px-[14px] py-2.5 bg-surface border-b border-signal-subtle text-[10px] uppercase tracking-[0.14em]">
      <WindowChrome size={9} />
