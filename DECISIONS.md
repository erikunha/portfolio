...
- **2026-05-18** · Spec 1.5 perf-fix Fix A deferred — CSS audit count 57 selectors across 7 files exceeded abort criterion (10/2). Fix A will return in a focused sub-spec if mobile LCP doesn't close from Fixes B + C alone.
