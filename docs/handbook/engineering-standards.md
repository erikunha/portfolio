...
- **AI usage.** The agent should use the mandated skills (brainstorming before features, TDD before implementation, systematic-debugging on bugs, verification-before-completion before claiming done). The agent self-reviews its diff before opening a PR (the 4-agent battery that used to do this was removed 2026-07-27); post-PR review is owned by claude-review.
