...
<div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',border:'1px solid var(--ds-color-signal-subtle)',marginBottom:'var(--ds-space-6)',marginLeft:'calc(-1 * var(--ds-space-pad))',marginRight:'calc(-1 * var(--ds-space-pad))'}}>
  <div style={{borderRight:'1px solid var(--ds-color-signal-subtle)'}}><StatTile value="8" label="PRIMITIVES" /></div>
  <div style={{borderRight:'1px solid var(--ds-color-signal-subtle)'}}><StatTile value="6" label="RSC" /></div>
  <div style={{borderRight:'1px solid var(--ds-color-signal-subtle)'}}><StatTile value="100" label="A11Y" /></div>
