<!-- AUTO-GENERATED by scripts/sync-copilot.ts — do not edit by hand.
     Source: /Users/erikhenriquealvescunha/.claude/skills/thinking-pre-mortem/SKILL.md
     Regenerate with: pnpm sync:copilot -->

---
mode: agent
description: 'Manually-invoked prompt — Copilot does not auto-trigger by description. Original Claude Code skill: thinking-pre-mortem.'
---
