...
This platform is designed for **long-term evolution**, **performance**, and **predictable operations**. Every architectural decision prioritizes maintainability, simplicity, and developer experience over enterprise complexity.

This is a **standard Next.js 16 application** optimized for Vercel deployment with Turbopack enabled.
...
- **Standard Next.js structure** for optimal Turbopack performance
...
| ------------------- | ------------------------ | ----------------------------------- |
| **Framework**       | Next.js 16+ (App Router) | SSR, Streaming, RSC, Turbopack      |
...
| **Visual**      | Manual Testing         | UI components (critical paths)      |
...
lib/
  ...
  infrastructure/           # System utilities (BFCache, Service Workers)
...
- **shared/** → Reusable UI components (button, etc.)
...
All visual decisions are defined in `styles/tokens.css`:
