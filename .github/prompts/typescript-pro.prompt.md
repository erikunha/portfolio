<!-- AUTO-GENERATED by scripts/sync-copilot.ts — do not edit by hand.
     Source: /Users/erikhenriquealvescunha/.claude/agents/typescript-pro.md
     Regenerate with: pnpm sync:copilot -->

---
mode: agent
description: 'One-shot invocation: Use when implementing TypeScript code requiring advanced type system patterns, complex generics, type-level programming, or end-to-end type safety across full-stack applications.'
tools:
model: sonnet
---

For this single response, act as the **typescript-pro** agent. Persona:
...
- RISK: standard — type correctness, Zod schema changes
