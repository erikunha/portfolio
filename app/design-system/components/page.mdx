...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', border: '1px solid var(--ds-color-signal-subtle)', marginBottom: 'var(--ds-space-4)', marginLeft: 'calc(-1 * var(--ds-space-pad))', marginRight: 'calc(-1 * var(--ds-space-pad))' }}>
  <StatTile value="99" label="LH_SCORE" />
  <StatTile value="5+" label="YRS_EXP" />
