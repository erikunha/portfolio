    ...
    >
      <div className="permatrix">
        ...
        <div className="pm-foot">
          <span><span className="pm-k">drwxr-xr-x</span>{'  i own it, you can read it, you can run against it'}</span>
          <span><span className="pm-k">drwxrwxrwx</span>{'  explicitly shared — please write here too'}</span>
          <span><span className="pm-k">drwxr-x---</span>{'  owned, run only by trusted group (security, compliance)'}</span>
          <span><span className="pm-k">-rwx------</span>{'  not delegable; this is the one i bring to the room'}</span>
        </div>
      </div>
    </Module>
  );
