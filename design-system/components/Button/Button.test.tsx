...
describe('Button', () => {
  ...
  it('applies primary variant styles by default', () => {
    ...
    expect(el?.classList.contains('bg-signal')).toBe(true);
    expect(el?.classList.contains('border-signal')).toBe(true);
  });
  it('applies secondary variant styles', () => {
    ...
    expect(el?.classList.contains('text-signal')).toBe(true);
  });
