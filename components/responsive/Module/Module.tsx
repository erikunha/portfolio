  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="flex-1 flex items-center gap-2 text-primary-500 font-mono text-xs md:text-[12px] font-medium tracking-[0.14em] md:tracking-[0.1em] uppercase m-0">
          {icon ? (
            <span
