...
<div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',border:'1px solid var(--color-primary-subtle)',marginBottom:'24px',marginLeft:'-24px',marginRight:'-24px'}}>
  <div style={{borderRight:'1px solid var(--color-primary-subtle)'}}><StatTile value="8" label="PRIMITIVES" variant="display" /></div>
  <div style={{borderRight:'1px solid var(--color-primary-subtle)'}}><StatTile value="6" label="RSC" variant="display" /></div>
